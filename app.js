...
const clientId = '53314da027904a1fbd04c75ade00fa06'; // your clientId
const redirectUrl = 'https://17seba17.github.io/spotify/';        // your redirect URL - must be localhost URL and/or HTTPS
...
async function createPlaylist() {
 const userData = await getUserData();
const user_id = userData.id; // Ottieni l'ID utente dal risultato di getUserData
const access_token = currentToken.access_token; // Assicurati di avere l'access token valido
...
request.post(options, (error, response, body) => {
  ...
  console.log('Risposta API Spotify:', body);
});
